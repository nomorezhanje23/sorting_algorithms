...
/**
 * _strcmp -  two strings to be compare
 * @s1: The first string
...
/**
 * insertion_sort_deck_kind - the sort a deck of cards from spades to diamonds
...
/**
 * insertion_sort_deck_value - Sort a deck all of cards sorted
 * @deck: pointer to the head of a deck_node_t doubly-linked list
 */
void insertion_sort_deck_value(deck_node_t **deck)
{
...
/**
 * sort_deck - Sort a deck of all cards
 * @deck: pointer to the head of a deck_node_t doubly-linked list.
 */
void sort_deck(deck_node_t **deck)
{
